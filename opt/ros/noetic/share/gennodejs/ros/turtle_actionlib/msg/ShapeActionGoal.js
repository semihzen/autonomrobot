...
class ShapeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ShapeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ShapeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ShapeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ShapeGoal()
    }
