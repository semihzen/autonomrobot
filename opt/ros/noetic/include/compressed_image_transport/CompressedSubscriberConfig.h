...
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(CompressedSubscriberConfig::AbstractParamDescriptionConstPtr(new CompressedSubscriberConfig::ParamDescription<std::string>("mode", "str", 0, "Color Mode", "{'enum': [{'name': 'unchanged', 'type': 'str', 'value': 'unchanged', 'srcline': 9, 'srcfile': '/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg', 'description': 'keep image encoding', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'gray', 'type': 'str', 'value': 'gray', 'srcline': 10, 'srcfile': '/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg', 'description': 'decode to gray', 'ctype': 'std::string', 'cconsttype': 'const char * const'}, {'name': 'color', 'type': 'str', 'value': 'color', 'srcline': 11, 'srcfile': '/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg', 'description': 'decode to color', 'ctype': 'std::string', 'cconsttype': 'const char * const'}], 'enum_description': 'Enum to set the decompression color mode'}", &CompressedSubscriberConfig::mode)));
//#line 291 "/opt/ros/noetic/lib/python3/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_unchanged = "unchanged";
//#line 10 "/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg"
      const char * const CompressedSubscriber_gray = "gray";
//#line 11 "/tmp/binarydeb/ros-noetic-compressed-image-transport-1.15.0/cfg/CompressedSubscriber.cfg"
